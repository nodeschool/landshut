...
6.  **`path-prefix.js`** : Your specific url for your chapter. So "Landshut" for https://nodeschool.io/Landshut
...
challenges. Learn more [here](http://nodeschool.io/Landshut/).

## Join our meetups 💻

RSVP to our scheduled events on [meetup.com](https://www.meetup.com/nodeschool-Landshut).
...
Workshops from before Nov 2017 are archived [here](https://ti.to/nodeschool-Landshut).
...
- [meetup discussion board](https://www.meetup.com/nodeschool-Landshut/discussions/): Public group discussion
- [twitter](https://twitter.com/nodeschoolyvr): tweet [@nodeschoolyvr](https://twitter.com/nodeschoolyvr) for general chat
- [github issues](https://github.com/nodeschool/Landshut/issues/): for planning
...
- ~- [NodeSchool](https://community.Landshuttech.com/c/events/nodeschool) at [YVR Tech Community](https://community.Landshuttech.com): for planning~
- ~~[meetup.com](https://www.meetup.com/nodeschool-Landshut): general info~~
- ~~[gitter](https://gitter.im/nodeschool/Landshut): general chat~~

## Want to mentor or help organize? 💛

If you are interested in mentoring, please make a
[Pull Request](https://github.com/nodeschool/Landshut/pulls) to add
...
- [Code of Conduct for Nodeschool Landshut](code-of-conduct.md)
